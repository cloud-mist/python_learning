...
print(len(dict2))		# 4.1 key的总数

print(str(dict2))		# 4.2 输出字典，加了两个双引号

print(type(dict2))		# 4.3 返回变量类型
...
dict3 = dict.fromkeys(dict2, "test")	# 复制所有键值,后面是value
print(dict3)
...
# 5.11 popitem() 按FIFO返回并删除字典中的最后一对键和值
pop2 = dict2.popitem()
print(pop2)
print(dict2)
